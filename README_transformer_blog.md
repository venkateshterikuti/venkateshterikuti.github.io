# Transformer From Scratch: The Scaling Journey from 2M to 52M Parameters
...
| Mini transformer training curve | Training throughput consistency |
|:---:|:---:|
| ![Mini transformer training curve](images/mac/train_loss.png) | ![Training throughput consistency](images/mac/train_tokens_per_s.png) |
...
| GPU training dynamics | GPU training throughput |
|:---:|:---:|
| ![GPU training dynamics](images/gpu/train_loss.png) | ![GPU training throughput](images/gpu/train_tokens_per_s.png) |
...
| **Hardware Cost** | $0 | $3-5/session | **∞** | Democratization vs Performance |
...
git clone https://github.com/venkateshterikuti/transformer-from-scratch
...
**[⭐ Star this repository](https://github.com/venkateshterikuti/transformer-from-scratch)** if you found this scaling journey helpful!
